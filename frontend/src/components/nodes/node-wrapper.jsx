...
export const NodeWrapper = ({ title, children, handles, id, icon: Icon }) => {
  ...
  return (
    <Card className="group relative w-[250px] p-5 rounded-xl border-2 border-[#1c1d1d67] bg-white transition-all hover:shadow-[0px_0px_0px_1px_#4a5568] hover:border-[#4a5568]">
      <button
